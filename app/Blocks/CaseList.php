...
class CaseList extends Block
{
    public $name = 'Case List';
    public $description = 'Show a list of cases...';
    public $category = 'widgets';
    public $icon = 'format-aside';
    public $keywords = ['reference', 'referenssit', 'grid'];
    public $mode = 'preview';
    public $supports = [
        'align' => ['full', 'wide'],
        'mode' => false,
