...
@else
  @blocks
    ...
    <div {!! wc_product_class('is-root-container', $product) !!} id="main-content" tabindex="-1">
      <!-- wp:woocommerce/store-notices /-->

      <div class="wp-block-columns is-layout-flex are-vertically-aligned-top alignwide is-style-media-text">
